...
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.loveConfig = {window = {title = "Ultimate Brick Breaker", width = 360, height = 640}}
function ____exports.configureLove(self)
    love.window.setTitle(____exports.loveConfig.window.title)
    love.window.setMode(____exports.loveConfig.window.width, ____exports.loveConfig.window.height, {centered = true, highdpi = true, msaa = 4, resizable = false})
    love.physics.setMeter(64)
end
return ____exports
 end,
["sounds.ballSound"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.ballHitOnSliderAndWalls = love.audio.newSource("/sounds/ballHitOnSliderAndWalls.mp3", "static")
____exports.ballHitOnSliderAndWalls:setVolume(0.5)
return ____exports
 end,
["images.brickImages"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.brickImages = {
    {
        normal = love.graphics.newImage("images/bricks/brick1.png"),
        broken = love.graphics.newImage("images/bricks/brick1-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick2.png"),
        broken = love.graphics.newImage("images/bricks/brick2-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick3.png"),
        broken = love.graphics.newImage("images/bricks/brick3-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick4.png"),
        broken = love.graphics.newImage("images/bricks/brick4-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick5.png"),
        broken = love.graphics.newImage("images/bricks/brick5-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick6.png"),
        broken = love.graphics.newImage("images/bricks/brick6-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick7.png"),
        broken = love.graphics.newImage("images/bricks/brick7-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick8.png"),
        broken = love.graphics.newImage("images/bricks/brick8-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick9.png"),
        broken = love.graphics.newImage("images/bricks/brick9-broken.png")
    },
    {
        normal = love.graphics.newImage("images/bricks/brick10.png"),
        broken = love.graphics.newImage("images/bricks/brick10-broken.png")
    }
}
return ____exports
 end,
["objects.Brick"] = function(...) 
...
local ____exports = {}
local ____brickImages = require("images.brickImages")
local brickImages = ____brickImages.brickImages
____exports.Brick = __TS__Class()
local Brick = ____exports.Brick
Brick.name = "Brick"
function Brick.prototype.____constructor(self, x, y)
    self.hits = 0
    self.id = tostring(math.floor(math.random() * 1000000))
    self.x = x
    self.y = y
    local random = math.floor(math.random() * #brickImages)
    self.originalImage = brickImages[random + 1].normal
    self.brokenImage = brickImages[random + 1].broken
end
__TS__SetDescriptor(
    Brick.prototype,
    "width",
    {get = function(self)
        return self.originalImage:getWidth() / 10
    end},
    true
)
__TS__SetDescriptor(
    ...
    "height",
    {get = function(self)
        return self.originalImage:getHeight() / 10
    end},
    true
)
__TS__SetDescriptor(
...
function Brick.prototype.draw(self)
    love.graphics.draw(
        self.isBroken and self.brokenImage or self.originalImage,
        self.x,
        self.y,
        0,
        0.1,
...
function Brick.prototype.update(self)
end
local BrickSet = __TS__Class()
BrickSet.name = "BrickSet"
function BrickSet.prototype.____constructor(self)
    self.bricks = {}
    do
        local i = 0
        while i < 30 do
            local ____self_bricks_0 = self.bricks
            ____self_bricks_0[#____self_bricks_0 + 1] = __TS__New(____exports.Brick, i * 40 % 360, i * 12)
            i = i + 1
        end
    end
end
function BrickSet.prototype.draw(self)
    __TS__ArrayForEach(
        self.bricks,
        function(____, brick) return not brick.isDestroyed and brick:draw() end
    )
end
____exports.brickSet = __TS__New(BrickSet)
return ____exports
 end,
["objects.Slider"] = function(...) 
local ____lualib = require("lualib_bundle")
local __TS__Class = ____lualib.__TS__Class
local __TS__SetDescriptor = ____lualib.__TS__SetDescriptor
local __TS__New = ____lualib.__TS__New
...
local loveConfig = ____config.loveConfig
local Slider = __TS__Class()
Slider.name = "Slider"
function Slider.prototype.____constructor(self)
    self.image = love.graphics.newImage("/images/sliders/slider1.png")
    self.x = (loveConfig.window.width - self.width) / 2
    self.y = loveConfig.window.height - self.height
    self.direction = "left"
    self.isMoving = false
    self.movingSpeed = 800
end
__TS__SetDescriptor(
    Slider.prototype,
    "width",
    {get = function(self)
        return self.image:getWidth() / 10
    end},
    true
)
__TS__SetDescriptor(
    ...
    "height",
    {get = function(self)
        return self.image:getHeight() / 10
    end},
    true
)
function Slider.prototype.draw(self)
    love.graphics.draw(
        self.image,
        self.x,
        self.y,
...
function Slider.prototype.update(self, dt)
    self:keyboardHandler(love.keyboard.isDown("left") and "left" or (love.keyboard.isDown("right") and "right" or "end"))
    if self.isMoving then
        self.x = self.x + (self.direction == "left" and -self.movingSpeed * dt or self.movingSpeed * dt)
    end
    self:normalize()
    self.isMoving = false
end
function Slider.prototype.keyboardHandler(self, key)
    self.isMoving = true
    repeat
        local ____switch9 = key
        local ____cond9 = ____switch9 == "left"
        if ____cond9 then
            self.direction = "left"
            break
        end
        ____cond9 = ____cond9 or ____switch9 == "right"
        if ____cond9 then
...
function Slider.prototype.normalize(self)
    if self.x + self.width >= loveConfig.window.width then
        self.x = loveConfig.window.width - self.width
    elseif self.x <= 0 then
        self.x = 0
    end
end
____exports.slider = __TS__New(Slider)
return ____exports
 end,
["objects.Ball"] = function(...) 
local ____lualib = require("lualib_bundle")
local __TS__Class = ____lualib.__TS__Class
local __TS__SetDescriptor = ____lualib.__TS__SetDescriptor
local __TS__New = ____lualib.__TS__New
...
local ____config = require("config")
local loveConfig = ____config.loveConfig
local ____ballSound = require("sounds.ballSound")
local ballHitOnSliderAndWalls = ____ballSound.ballHitOnSliderAndWalls
local ____Brick = require("objects.Brick")
local brickSet = ____Brick.brickSet
local ____Slider = require("objects.Slider")
local slider = ____Slider.slider
____exports.Ball = __TS__Class()
local Ball = ____exports.Ball
Ball.name = "Ball"
function Ball.prototype.____constructor(self)
    self.image = love.graphics.newImage("/images/balls/ball1.png")
    self.x = (loveConfig.window.width - self.width) / 2
    self.y = loveConfig.window.height - self.height - slider.height
    self.speed = 200
    self:reset()
end
__TS__SetDescriptor(
...
function Ball.prototype.draw(self)
    love.graphics.draw(
        self.image,
        self.x,
        self.y,
...
function Ball.prototype.update(self, dt)
    self:updateBallDirection()
    self.x = self.x + self.xSpeed * dt
    self.y = self.y + self.ySpeed * dt
end
function Ball.prototype.updateBallDirection(self)
    if self:isHittingTheSlider() then
        self.ySpeed = -1 * self.ySpeed
    end
    self:handleCollisionOnWall()
    if self.y >= loveConfig.window.height - slider.height then
        self.x = loveConfig.window.width / 2
        self.y = loveConfig.window.height / 2
        self:reset()
    end
end
function Ball.prototype.isHittingTheSlider(self)
    local isInYRange = self.y + self.height >= slider.y and self.y + self.height <= loveConfig.window.height
    local isInXRange = self.x + self.width >= slider.x and self.x + self.width <= slider.x + slider.width
    return isInXRange and isInYRange
end
function Ball.prototype.isHittingTheBrick(self, brick)
    local isInYRange = self.y + self.height >= brick.y and self.y + self.height <= brick.y + brick.height
    local isInXRange = self.x + self.width >= brick.x and self.x + self.width <= brick.x + brick.width
    return isInXRange and isInYRange
end
function Ball.prototype.handleCollisionOnWall(self)
    if self.x >= loveConfig.window.width - self.width or self.x <= 0 then
        if ballHitOnSliderAndWalls:isPlaying() then
...
function Ball.prototype.reset(self)
    self.xSpeed = ({
        1,
        2,
        3,
        ...
        -2,
        3
    })[math.floor(math.random() * 6) + 1] * self.speed
    self.ySpeed = -4 * self.speed
end
local BallSet = __TS__Class()
BallSet.name = "BallSet"
function BallSet.prototype.____constructor(self)
    self.balls = {}
    local ____self_balls_0 = self.balls
    ____self_balls_0[#____self_balls_0 + 1] = __TS__New(____exports.Ball)
end
function BallSet.prototype.add(self)
    local ____self_balls_1 = self.balls
    ____self_balls_1[#____self_balls_1 + 1] = __TS__New(____exports.Ball)
end
function BallSet.prototype.update(self, dt)
    __TS__ArrayForEach(
        self.balls,
        function(____, ball) return ball:update(dt) end
    )
    self:checkCollisonWithBricks(brickSet.bricks)
end
function BallSet.prototype.draw(self)
    __TS__ArrayForEach(
        self.balls,
        function(____, ball) return ball:draw() end
    )
end
function BallSet.prototype.checkCollisonWithBricks(self, bricks)
    __TS__ArrayForEach(
        bricks,
        function(____, brick, index)
            __TS__ArrayForEach(
                self.balls,
                function(____, ball)
                    local doesHit = ball:isHittingTheBrick(brick)
                    if doesHit then
                        brick.hits = brick.hits + 1
                        if not brick.isDestroyed then
...
____exports.ballSet = __TS__New(BallSet)
return ____exports
 end,
["images.backgroundImages"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.backGroundImage = love.graphics.newImage("/images/backgrounds/background1.png")
return ____exports
 end,
["main"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local ____config = require("config")
local configureLove = ____config.configureLove
local ____Ball = require("objects.Ball")
local ballSet = ____Ball.ballSet
local ____Brick = require("objects.Brick")
local brickSet = ____Brick.brickSet
local ____Slider = require("objects.Slider")
local slider = ____Slider.slider
local ____backgroundImages = require("images.backgroundImages")
local backGroundImage = ____backgroundImages.backGroundImage
configureLove(nil)
love.load = function()
end
...
["images.ballImages"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
 end,
["images.sliderImages"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
 end,
}
return require("main", ...)
